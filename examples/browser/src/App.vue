      ...
      <n-notification-provider placement="bottom-right">
        <n-layout embedded class="layout" style="height: 100vh">
          ...
          <h1>
            ...
            <span>totp-wasm-zig</span>
          </h1>

          <div class="content">
            <n-space vertical>
              <n-input-group>
                <n-input-group-label style="width: 120px"> Secret Key </n-input-group-label>
                <n-input v-model:value="secret" type="text" clearable />
                <n-button type="primary" @click="secret = generateSecret()"> Generate </n-button>
              </n-input-group>

              <n-input-group>
                <n-input-group-label style="width: 120px"> Digits </n-input-group-label>
                <n-input-number v-model:value="digits" :max="9" style="width: 100%" />
              </n-input-group>

              <n-input-group>
                <n-input-group-label style="width: 120px"> Period </n-input-group-label>
              ...
              <n-input-group>
                <n-input-group-label style="width: 120px"> HOTP Counter </n-input-group-label>
                <n-input-number
            ...
            <n-space vertical>
              <n-progress type="line" :percentage="Math.round((tr / period) * 100)">
                {{ tr }} sec
              </n-progress>

              <n-input-group>
                <n-input-group-label style="width: 120px"> HOTP Value </n-input-group-label>
                <n-input v-model:value="hotp_value" type="text" readonly />
              </n-input-group>

              <n-input-group>
                <n-input-group-label style="width: 120px"> TOTP Value </n-input-group-label>
                <n-input v-model:value="totp_value" type="text" readonly />
              </n-input-group>

              <n-input-group>
                <n-input-group-label style="width: 120px"> Steam Value </n-input-group-label>
            ...
            <n-space vertical>
              <n-input-group>
                <n-input-group-label style="width: 120px"> Issuer </n-input-group-label>
                <n-input v-model:value="issuer" type="text" clearable />
              </n-input-group>

              <n-input-group>
                <n-input-group-label style="width: 120px"> Account </n-input-group-label>
                <n-input v-model:value="account" type="text" clearable />
              </n-input-group>

              <div class="qrcode">
                <qrcode-vue :value="totp_uri" render-as="svg" :size="300" :margin="3" level="L" />
              </div>
            </n-space>
          </div>
        </n-layout>
